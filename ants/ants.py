...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        if self.place.ant is None:
            return False
        elif  self.place.ant is not None and self.place.ant.blocks_path == False:
            return False
        else:
            return True
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place = self.place
        place_count = 0
        while place != hive and place.entrance != None  :
            if random_or_none(place.bees) == None or place_count<self.min_range or place_count>self.max_range :
