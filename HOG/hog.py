...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while Counter < num_rolls:
        individual_roll=dice()
        if individual_roll==1:
            pig=True
        sum_of_rolls = sum_of_rolls+individual_roll
        Counter +=1
    if pig:
        return 1
    else:
...
def take_turn(num_rolls, opponent_score, dice2=six_sided):
    ...
    if num_rolls ==0:
        ...
        return roll_dice(num_rolls, dice2)
    # END PROBLEM 3
...
def is_swap(score0, score1):
    ...
    if score1> 1 and score0> 1:
        if score1%score0==0 or score0%score1==0:
            return True
        else:
            return False
    return False
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0,score1):
        ...
        if score > previous_score:
            current_difference = score - previous_score
            if current_difference > previous_high:

                if current_difference==1:
                    print (current_difference ,"point! That's the biggest gain yet for Player", who)
                else:
                    print (current_difference ,"points! That's the biggest gain yet for Player", who)
                return announce_highest(who,current_difference,score)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while number_dice<10:
        number_dice+=1
        current_dice=average_function(number_dice,dice)
